export default {
  ...
  'GRAPH.TITLEBAR.EXPORT_IMAGE': 'Export graph as image file',
  ...
  'GRID.TABLE.LOAD_ALL_ROWS': 'Load all rows',
  'GRID.TABLE.LOAD_MORE_ROWS': 'Load %s more rows',
  'GRID.TABLE.SHOWING_ROWS': 'Showing rows 1–%s of %s.',
  ...
  'GRID.TABLE.SORT_MENU.TOOLTIP': 'Click to sort',
